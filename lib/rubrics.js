...
Output strict JSON only, matching this schema:
{
  ...
  "verdict": "correct | partially_correct | incorrect | too_vague_to_grade | example_requested",
  "flagged_claim": "string or null",
  "detailed_feedback": "A comprehensive, multi-sentence technical evaluation analyzing the candidate's response in detail — explaining what was solid, what exact technical concepts or steps were missing, and why it matters in a real security assessment",
  "strengths": ["array of specific technical points the candidate got right"],
  "gaps_and_omissions": ["array of specific technical details, tools, headers, payloads, or steps that were missing or vague"],
  "what_a_strong_answer_includes": "string",
  "improved_answer_sample": "An exemplary, senior-level sample response demonstrating how to answer this question with full technical precision",
